...
cred = []
mac_add = raw_input("Enter the Access Point MAC Address: ")
#
...
dev.send('y' + '\n')
time.sleep(5)
dev.send('debug mac addr ' + mac_add + '\n')
dev.send('debug capwap error enable\n')
dev.send('debug capwap event enable\n')
dev.send('debug pm pki enable\n')
time.sleep(60)
