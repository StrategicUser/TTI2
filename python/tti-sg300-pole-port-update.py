...
with open('files/sg300-iplist.txt', 'r') as ccthost:
	for line in ccthost:																											
		...
		d_cnt = 0
		port_dclr = ['gi1','gi2','gi3','gi4','gi5','gi6','gi7','gi8']
		...
		#d_cnt = d_cnt + 1																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																										
		with open('files/mac-sg300-table.txt', 'r') as tmac:
			for line1 in tmac:
